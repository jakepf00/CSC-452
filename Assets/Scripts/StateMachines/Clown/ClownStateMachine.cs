...
public class ClownStateMachine : StateMachine {
    [field: SerializeField] public CharacterController CharacterController { get; private set; }
    [field: SerializeField] public Animator Animator { get; private set; }
    [field: SerializeField] public ClownForceReceiver ForceReceiver { get; private set; }
    ...
    void Start() {
        ...
        //SwitchState(new ClownIdleState(this));
    }
    void OnEnable() {
    ...
    void OnDamage() {
        //SwitchState(new ClownImpactState(this));
    }
    void OnDeath() {
        //SwitchState(new ClownDeathState(this));
    }
